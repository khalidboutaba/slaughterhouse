    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>العملاء</h3>
                <p class="text-subtitle text-muted">تعديل عميل</p>
            </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name" class="form-control"
                                                placeholder="الإسم" name="name" value="{{ old('name', $customer->name) }}" required>
                                            @error('name')
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="phone" class="form-control"
                                                placeholder="الهاتف" name="phone" value="{{ old('phone', $customer->phone) }}" required>
                                            @error('phone')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
