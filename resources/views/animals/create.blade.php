...
@section('title', 'إضافة ماشية جديد')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>المواشي</h3>
                <p class="text-subtitle text-muted">إضافة ماشية جديدة</p>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">يرجى ملء النموذج لإضافة ماشية جديدة إلى النظام.</h4>
                    </div>
                    @if ($errors->any())
                        ...
                        <div class="card-body">
                            <form class="form" method="POST" action="{{ route('animals.store') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="type" id="cow" value="بقر" {{ old('type', $animal->type ?? 'بقر') == 'بقر' ? 'checked' : '' }}>
                                                <label class="form-check-label" for="cow">بقر</label>
                                            </div>
                                            
                                            <div class="form-check mt-3">
                                                <input class="form-check-input" type="radio" name="type" id="sheep" value="خروف" {{ old('type', $animal->type ?? '') == 'خروف' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="entrails_price" class="form-control"
                                                placeholder="سعر الأحشاء" name="entrails_price" value="{{ old('entrails_price') }}" required>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="supplier">المنشأ</label>
                                            <select class="choices form-select" name="origin">
                                                <option value="" disabled selected>اختر المنشأ</option>
                                                <option value="محلي" {{ old('origin') == 'محلي' ? 'selected' : '' }}>محلي</option>
                                                <option value="أجنبي" {{ old('origin') == 'أجنبي' ? 'selected' : '' }}>أجنبي</option>
                                                <option value="غير معروف" {{ old('origin') == 'غير معروف' ? 'selected' : '' }}>غير معروف</option>
                                            </select>
                                            @error('origin')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="supplier">المورد <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="reference" class="form-control"
                                                placeholder="الرقم المرجعي" name="reference" value="{{ old('reference') }}">
                                            @error('reference')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
