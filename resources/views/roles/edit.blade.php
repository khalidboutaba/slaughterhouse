    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>الأدوار</h3>
                <p class="text-subtitle text-muted">تعديل دور</p>
            </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name" class="form-control"
                                                placeholder="إسم الدور" name="name" value="{{ old('name', $role->name) }}" required readonly>
                                            @error('name')
                                            ...
                                            <ul class="list-group">
                                                @foreach($permission as $value)
                                                    <li class="list-group-item">
                                                        <input id="checkbox-{{ $value->id }}" class="form-check-input me-1" type="checkbox" name="permission[{{ $value->id }}]" value="{{ $value->id }}" {{ in_array($value->id, $rolePermissions) ? 'checked' : '' }}>
